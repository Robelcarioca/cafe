  ...
  return (
    <div className="fixed bottom-6 right-4 z-50 flex flex-col gap-3 sm:right-6">
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="flex h-14 w-14 items-center justify-center rounded-full bg-brand-brown text-white shadow-float"
        aria-label="Call us"
      >
      ...
      <motion.a
        ...
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-float"
